# Contributing to GMLC-TDC CMAKE-helpers

:+1: First off, thank you for taking the time to contribute! :+1:

The following is a set of guidelines for contributing to cmake-helpers, HELICS and associated projects. These are suggested guidelines. Use your best judgment.
...
This section guides you through submitting a bug report for HELICS and associated repositories. Following these guidelines helps maintainers and the community understand your report, reproduce the behavior, and find related reports.
...
## Styleguides
Code formatting is controlled via cmake-format,
